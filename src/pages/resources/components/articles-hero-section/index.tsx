...
const ContentHeroSection: React.FC<any> = ({
  ...
  return (
    <section className="common-component w-full h-full relative bg-gradient-to-tr from-primary/50">
      ...
      <div className="hidden md:flex absolute w-full h-full justify-end pt-18 md:pt-0 md:items-center"></div>
