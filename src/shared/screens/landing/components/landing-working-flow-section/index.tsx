...
const LandingWorkingFlowSection: React.FC<any> = ({
  ...
  return (
    <section className="common-component bg-custom-grey-1 text-black relative">
      <StackIllustration className="absolute -right-26 md:-right-48 bottom-0 w-48 md:w-md fill-current text-white mb-8" />
              ...
              <div
                ...
                className={cn(
                  ...
                  index !== workingFlowSection.items.length - 1 &&
                    'md:pr-8 border-b border-b-custom-grey-2 md:border-b-0 md:border-r md:border-r-custom-grey-2'
                )}
              >
