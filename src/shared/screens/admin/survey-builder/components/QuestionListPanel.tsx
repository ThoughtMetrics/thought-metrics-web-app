...
const TYPE_BADGE_COLORS: Partial<Record<QuestionType, string>> = {
  ...
  [QuestionType.NUMBER]: 'bg-white/[0.06] text-outline',
  [QuestionType.EMAIL]: 'bg-white/[0.06] text-outline',
  [QuestionType.PHONE]: 'bg-white/[0.06] text-outline',
  [QuestionType.DATE]: 'bg-white/[0.06] text-outline',
...
const TYPE_LABELS: Partial<Record<QuestionType, string>> = {
  ...
  [QuestionType.TEXT_DISPLAY]: 'Display',
  [QuestionType.MCQ_SINGLE]: 'Single',
  [QuestionType.MCQ_MULTIPLE]: 'Multiple',
  [QuestionType.RANKING]: 'Ranking',
  [QuestionType.RATING]: 'Rating',
  [QuestionType.LIKERT_SCALE]: 'Likert',
  [QuestionType.SCALE]: 'Scale',
  [QuestionType.DOUBLE_SLIDER]: 'Range Slider',
...
const QuestionListPanel: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-surface-container border-r border-outline-variant">
      {/* Panel header */}
      <div className="px-3.5 pt-3.5 pb-2.5 border-b border-outline-variant flex items-center justify-between flex-shrink-0">
        <span className="text-[11px] font-semibold text-outline uppercase tracking-[0.06em]">Questions</span>
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <span
                      className={`inline-block text-[10px] font-semibold px-1.5 py-0.5 rounded-full mb-1 ${badgeColor}`}
                    >
