...
const QuestionListPanel: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-white border-r border-gray-200">
      ...
      {/* Questions list */}
      <div className="flex-1 overflow-y-auto p-2 space-y-1" onClick={() => setInsertMenuOpenAt(null)}>
        {questions.length === 0 && (
            ...
            <React.Fragment key={q.id}>
              ...
              {idx < questions.length - 1 && (
                ...
                >
                  ...
                  <button
                    onClick={(e) => { e.stopPropagation(); setInsertMenuOpenAt(insertMenuOpenAt === idx ? null : idx); }}
                      ...
                      {QUESTION_GROUPS.map((group) => (
                        <div key={group.label}>
                          ...
                          {group.types.map(({ type, label }) => (
                            <button
                              key={type}
                              onClick={() => { insertQuestion(type, idx); setInsertMenuOpenAt(null); }}
      ...
      <div className="p-3 border-t border-gray-200 relative">
        <button
          onClick={() => { setAddMenuOpen((v) => !v); setInsertMenuOpenAt(null); }}
