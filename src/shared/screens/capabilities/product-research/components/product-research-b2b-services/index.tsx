      ...
      <div className="common-container px-6 py-8 md:px-24 md:py-12 justify-center flex-col max-w-(--breakpoint-2xl)!">
        ...
        <div className="hidden md:grid grid-cols-1 w-full md:grid-cols-3  md:grid-rows-2 gap-3 pt-6 text-black">
          ...
          <a
            ...
            className="relative col-span-2 bg-linear-to-r from-custom-violet to-white rounded-md flex flex-col justify-center py-9 px-12 overflow-hidden group hover:shadow-xl transition-shadow duration-300"
          >
            <div className="flex flex-col gap-8">
...
export default ProductResearchB2BServices;
