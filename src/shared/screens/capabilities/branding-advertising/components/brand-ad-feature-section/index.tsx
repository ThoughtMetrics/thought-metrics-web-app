...
const BrandAdFeatureSection: React.FC<any> = ({
  ...
  return (
    <section className="common-component relative bg-primary text-black brand-ad-component">
      <div className="hidden md:flex absolute xl:w-40 xxl:w-[11rem] wide:w-[13rem] h-fit justify-start items-center md:p-0 z-1 left-0 top-1/2 transform -translate-y-1/2">
