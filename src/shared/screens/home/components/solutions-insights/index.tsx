...
import { solutionsInsights } from '@/core/constants/page-constants/home-solutions-insights-constant';
import { ArrowRight } from '@/assets';
import { cn } from '@/core/utils/cn';
import illustration_model from 'images/illustration_model.png';
        ...
        <div className="w-full md:w-[36rem] grid md:grid-cols-2 md:flex md:gap-3 items-start">
          <div className="col-span-1 w-full h-full relative py-4 flex justify-center">
            <div className="shrink-0">
              <img
                src={illustration_model.src}
                alt="Person with phone illustration"
                className="width-full h-full md:max-h-[30rem] shrink-0"
              />
            </div>
          </div>
