...
const PolicyHeroSection: React.FC<{ content: string; head: string }> = ({
  ...
  return (
    <section className="common-component w-full h-full flex-col items-center">
      <div className="policies-component w-full min-h-[240px] md:min-h-[480px] xxl:p-0 z-1 flex items-center relative">
        <h2 className="pl-[15%] text-xl md:text-4xl font-semibold">{head}</h2>
