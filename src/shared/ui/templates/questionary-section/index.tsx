    ...
    <section className="common-component relative bg-primary-lighter text-black">
      ...
      >
        <div className="w-full md:w-[80%] flex flex-col gap-3">
          <h2 className="text-xl md:text-3xl font-semibold leading-tight tracking-wide flex flex-col gap-2">
    ...
    <section className="common-component relative bg-primary-lighter text-black">
      ...
      >
        <div className="w-full flex flex-col gap-3">
          <h2
            className={cn(
              'w-54 xl:w-[20rem] text-xl md:text-3xl font-semibold leading-tight tracking-wide gap-2 relative',
              titleClassName
            )}
          >
            <span>{questionarySection.title}</span>
            ...
            <div
              className={cn(
                'absolute top-2 -right-14 xl:-right-8 xxl:-right-[4.5rem]',
                illustrationClassName
              )}
            >
              <StackIllustration className="fill-current text-primary h-full w-48 xl:w-56 xxl:w-[17rem] pt-14 xl:pt-20.5" />
            </div>
            <div className="h-40 xl:h-48"></div>
          </h2>
        </div>
        <div className="w-full h-full">
          <QuestionaryCard
